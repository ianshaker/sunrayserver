...
module.exports = {
  ...
  description:
    ...
    "(сегодня, вчера, конкретная дата) ИЛИ прошедшие/последние без даты " +
    "(N ближайших к сегодня, но раньше сегодня): «дай дедлайны по погрузке», " +
    "«скинь дедлайны по замерам», «дай 5 прошедших дедлайнов по погрузке», " +
    "«дай 5 последних», «5 шт прошедшие даты», «самый срочный дедлайн по погрузке». " +
  ...
  examples: [
    ...
    "дай дедлайны по погрузке 5 шт прошедшие даты",
    "дай 5 прошедших дедлайнов по погрузке",
    "дай 5 последних дедлайнов по замерам",
