...
module.exports = {
  ...
  description:
    ...
    "Обычно есть номер заявки (#NNNNN) или reply на карточку «⏰ Дедлайн #…» (или старую «ДЕДЛАЙН ПОГРУЗКИ #…»). " +
  ...
  examples: [
    ...
    "верни во входящие (reply на карточку «⏰ Дедлайн #…»)",
    "#08044 назначить на Антона завтра в 14:00",
    "назначь замер Роме на 10 июля в 11 (reply на карточку «⏰ Дедлайн #…»)",
