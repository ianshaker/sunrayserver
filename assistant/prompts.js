...
- Вопросы/просьбы ПОКАЗАТЬ дедлайны по входящим/заявкам/обращениям («дай», «покажи», «какие», «есть ли», «список», «самый срочный») → appeal_deadline_query, НЕ appeal_deadline_manage и НЕ task_*.
- appeal_deadline_manage — только действие над конкретной заявкой: перенести, отказ, погрузка, добавить инфо (обычно есть #NNNNN или reply на карточку ДЕДЛАЙН).
- «дедлайн» у manager-задачи («перенеси задачу», «создай задачу с дедлайном») → task_manage / task_create, не appeal_deadline_*.
